...
Naturally, I was drawn toward this model as I've heard it frequently referenced in finance, particularly w/r/t the random walk hypothesis \cite{RandomWalkHypothesis2026}, where it's hypothesized that stocks follow a random walk about some mean increase.  Much of that Wikipedia page is dedicated toward ``debunking'' this statement in terms of its quantitative consequences, but of course one should understand the idea.

I'd heard of a similar, biased walk discussed in terms of the probability distribution of stock returns.  For example, consider a stock with price $p$ that moves up or down in price by $\epsilon p$, and does so--proportionately--at every step.  The conversational claim was that this would naturally produce a skewed distribution toward unlikely but large gains, both due to bounding the price $p>0$ and to the exponential growth of a lucky streak.


\section{Ben Felix - Finding and Funding a Good Life}

\subsection{Introduction}
In \cite{Felix2026}, Ben starts off by stating that people struggle to predict what will meaningfully impact their happiness in the long term. 


\subsection{Circumstances and adaptation}
Because people rapidly adapt to both good and bad circumstances, often a seemingly big chance requiring a lot of sacrifice turns out to not produce the expected payoff (e.g., a big house, a nice car, etc.).  Further, Ben notes an ``end of history'' illusion, where people feel they've finally arrived at their final self, despite acknowledging constant changes in the past 5, 10, 15, or more years of their life.  The end of history illusion makes it difficult to know whether someone's long-term goal will be equally satisfying to their future self, when it's actually achieved.

It's noted that, similar to other goals or large investments, income tends to satiate at relatively modest levels.  Working harder for more money is not always a good tradeoff, and the highest levels of achievement can lead to more dissatisfaction if too demanding.

There are follow-on sections for life-creep related expenses like a vacation home and luxury vehicles.  The basic concept is the same, where you should ask what the actual utility for this purchase is vs. the opportunity cost of those funds.  E.g., could you get more happiness out of a cheaper car and a couple of extra vacations?  Or, would you enjoy the flexibility of arranging a family vacation semi-frequently, vs. managing a family vacation property full time?

Curiously, he notes that nearby green space (trees, parks, and nature experiences) have a stronger positive benefit than people expect.

This section ends with a connsiderations of negative environmental aspects that {\it are not} easily adaptable.  Ben lists noise (traffic, trains, etc.), commuting, and lack of control as negative issues that will wear down on someone over time.  Curiously, then, if you feel a lack of control over your environment, home ownership may have a lasting positive impact on you since you could feel in control of changes or improvements to the home.

\subsection{Things vs. experiences}
Notes that experiences tend to bring more value than material purchases.

\subsection{Time vs. Money}
Money is easy to quantify and see growing or shrinking, whereas the value of time is difficult to pin down.  People naturally tend to prefer money to time, despite the fact that those who prioritize time seem to be happier {\it even at lower income levels.}  Trading money for time is a valid strategy at all income levels (see Whillan's book {\it Time Smart}).

\subsection{Regret}
Because outcomes are not certain, regret naturally comes from the {\it what if} when seemingly easy opportunities are missed.  It appears that barely missing out on a huge win causes more regret than satisfaction from barely missing out on a loss.  Because feelings of regret are strong, we risk interpreting hindsight actions as {\it causal} in the negative outcome, rather than happenstance.  Investors need to avoid changing their strategy due to unforeseen outcomes that {\it could have} been avoided or capitalized on, particularly when these opportunities only exist if you assume perfect foresight.

Persistent regrets appear to involve inaction, rather than action.  For example, not pursing a romantic interest is a common regret that sticks with people.

\subsection{Model for a good life}
This section appears to summarize the PERMA model for living a fulfilling life.

Positive emotion is first, which has a dual nature in that we are never fully satiated on positive feelings.  This leads to a ``hedonic treadmill,'' where we're always looking for the next increase in positive feelings.

Engagement is second, and involves your ability to get lost in your work.  This is fulfilling work that uses your skills and challenges you commensurately to what you're able to accomplish.

Relationships are next, where it's asked to consider how you could trade money for deeper relationships or engagements with existing ones.

Meaning is next, which involves contributing to, or being a part of, something larger than yourself.  This can be community, family, religion, etc., but encompasses your purposes beyond your personal needs.

Accomplishment rounds out the PERMA model, and is sought out for its own sake.  One should consider what they're working toward, what they've mastered, and what they hope to master.

Vitality is an addition from Ben, which focuses on getting quality diet, exercise, and sleep.  He notes that physical and mental wellbeing are connected, hence this final addition.  My note: there's nothing to plan for if you're not alive in the future.

\subsection{Setting goals}
This section starts by noting that financial planners are quite capable of producing plans to meet goals, provided that clients know which financial goals will provide them the most future happiness.  This is to suggest that it's unlikely for clients to come in with a prepared set of goals that they've carefully thought out and that, when tested, would actually generate the positive outcomes they want.  As a result, Ben suggests that the planner-client interaction should start with an exercise to generate objectives, rather than assume that the client's objectives are already known.

{\bf Suggested exercise}: Ben suggests having the client create a list of objectives, which is followed-up by asking them to {\it double} the size of that list.  Further, the client should be prompted with something like the PERMA-V model afterward to see if these categories suggest further objectives.  This is an attempt to really suss out any blindspots by encouraging broader and broader thinking.

Ben suggests setting {\it effective goals}, where the desired state it outlined, rather than the actions needed to get there.  Often, goals are positive (e.g., {\it I will achieve this goal by this date}), rather than negative (e.g., {\it I will not do a certain activity for some period of time}).  It sounds like positive goals are often more effective, but some avoidance issues and personal motivation factors may make avoidance goals effective in certain circumstances.

Ben heavily cites the Fishbach book {\it Get it done} as being a useful resource for actually achieving goals, once set.  One interesting piece of advice is to have the client engage in determining the action to achieve a goal, so that they feel a sense of agency over their strategy.

Be aware that goals can conflict with one another, and consider how to resolve conflicts (e.g., picking higher-priority goals, or those that more closely resonate with one's self identity).

\subsection{Conclusion}

Ben acknowledges Brian Portnoy's book {\it The geometry of wealth} and his website at \url{https://www.shapingwealth.com/}.  On a cursory glance, I didn't find these all that helpful.
